...
{
    /*YOU SHOULD CREATE NEW OBJECT TO BE PROJECTILE
    ...
    [SerializeField] private GameObject projectileEffect; // Projectile impact
    ...
    private void OnCollisionEnter2D() // When it collides with another object
    {
        ...
        Instantiate(projectileEffect, transform.position, Quaternion.identity); // Shot impact
